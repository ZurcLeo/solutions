...
exports.createMessage = async (req, res) => {
  try {
    const { uidRemetente, uidDestinatario, conteudo, tipo } = req.body;
    const newMessage = {
      uidRemetente,
      uidDestinatario,
      conteudo,
...
exports.updateMessage = async (req, res) => {
  try {
    const { uidRemetente, uidDestinatario, id } = req.params;
    const updatedMessage = await Message.update(uidRemetente, uidDestinatario, id, req.body);
...
exports.deleteMessage = async (req, res) => {
  try {
    const { uidRemetente, uidDestinatario, id } = req.params;
    await Message.delete(uidRemetente, uidDestinatario, id);
