...
module.exports = function kycRejectedTemplate(data) {
  ...
  const bodyContent = `
      ...
      <div style="text-align:center; margin-bottom:32px;">
        <a href="${APP_URL}/suporte" class="btn" style="display:inline-block; background:${P}; color:#FFFFFF !important; padding:12px 24px; border-radius:10px; text-decoration:none; font-weight:600; font-size:14px;">Falar com o suporte &rarr;</a>
      </div>
