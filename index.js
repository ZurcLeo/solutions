...
const sellerRoutes = require('./routes/seller'); // Add seller routes import
...
app.use('/api/sellers', (req, res, next) => logRoute(sellerRoutes)(req, res, next)); // Add seller routes
